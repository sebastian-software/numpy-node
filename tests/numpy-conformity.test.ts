 ...
 * The reference values are generated by scripts/generate_numpy_reference.py
 * and stored in scripts/numpy_reference.json.
 *
 * Run `python3 scripts/generate_numpy_reference.py` to regenerate reference values.
 */
